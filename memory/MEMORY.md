...
## Migrated to native Claude Code skills (on-demand load, ~/.claude/skills/)

These were previously auto-loaded via `@-imports` in CLAUDE.md (or listed as "on-demand memories" for the Google ones). Now they live as skills and Claude Code loads them automatically when the description matches the conversation context. The original `reference_*.md` files are kept as backup but are no longer auto-loaded.

- **shodan-recon** → `~/.claude/skills/shodan-recon/SKILL.md` (backup: `reference_shodan_recon.md`)
- **pentest-skills** → `~/.claude/skills/pentest-skills/SKILL.md` (backup: `reference_pentest_skills.md`)
- **h1-bugbounty** → `~/.claude/skills/h1-bugbounty/SKILL.md` (backup: `reference_h1_skills.md`)
- **bugcrowd-bugbounty** → `~/.claude/skills/bugcrowd-bugbounty/SKILL.md` (backup: `reference_bugcrowd_skills.md`)
- **google-bughunters** → `~/.claude/skills/google-bughunters/SKILL.md` (backup: `reference_bughunters_skills.md`)
- **google-vrp-public-hof** → `~/.claude/skills/google-vrp-public-hof/SKILL.md` (backup: `reference_google_vrp_public_hof.md`)
